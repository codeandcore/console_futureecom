<template>
  <v-expansion-panels v-if="value.shipping_address" flat :value="0">
    <v-expansion-panel>
      <v-expansion-panel-header class="text-h6">
        {{ $t('Shipping address') }}
      </v-expansion-panel-header>
      <v-expansion-panel-content>
        <orderable-address-preview :value="value.shipping_address" />
      </v-expansion-panel-content>
    </v-expansion-panel>
  </v-expansion-panels>
</template>
...
export default defineComponent({
  name: 'OrderablePreviewShippingAddress',
  components: { OrderableAddressPreview },
  props: {
    value: {
